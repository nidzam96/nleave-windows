    ...
    <div class="section-2">
        ...
        <div class="tab-content">
        	...
        	<div role="tabpanel" class="tab-pane" id="claim">
        		<section class="section-secondary section-claim">
					<div class="row">
						<div class="panel panel-primary">
							<div class="panel-heading">
								<span class="fa fa-pencil"></span>
							...
							<div class="panel-body">
								<a href="#" type="button" id="claimAdd" class="btn btn-success">Add claim</a>
								
								<!-- the popup to add new claim -->
								<div id="claimModal" class="modal" style="overflow-y: auto">
							    	...
							    	<div class="modal-content" style="width: 50%; height: 500px;">
										...
										<div class="panel panel-primary">
											...
											<div class="panel-body">
												<form method="POST" action="{{ route('setting.claim') }}">
													{{ csrf_field() }}
													
													<label>Claim Name</label>
													<input type="text" name="claim_name" placeholder="Please enter claim name" class="form-control" required="required">

													<label>Description</label>
													<input type="text" name="claim_desc" class="form-control" placeholder="Please enter claim description">
									...
									<table class="table table-bordered">
										...
										<tbody>
											<tr>
												...
												<td>
													<a href="{{ route('setting.claim.edit', $claim->id) }}" class="btn btn-warning">
														<span class="fa fa-edit"></span>
														Edit
													</a>
													<a href="#" class="btn btn-danger">
...
@section('extrascripts')
	<script type="text/javascript">
		...
		// The popup for creating new claim 
		var claimmodal = document.getElementById('claimModal');
		var claimbtn = document.getElementById("claimAdd");
		var claimspan = document.getElementsByClassName("close")[0];
